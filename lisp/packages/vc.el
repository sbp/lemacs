...
(defconst vc-default-menu
  '(["NEXT-OPERATION"			vc-next-action		t nil]
    ...
    ["Visit Previous Revision..."	vc-visit-previous-revision	t]
...
(defun vc-sensitize-menu ()
  (let* ((rest (cdr (car (find-menu-item current-menubar '("VC")))))
	 (case-fold-search t)

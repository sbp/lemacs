;; DIRED commands for Emacs.  $Revision: 5.246 $
...
(defconst dired-version (substring "$Revision: 5.246 $" 11 -2)
  "The revision number of Tree Dired (as string).  The complete RCS id is:

  $Id: dired.el,v 5.246 1992/02/20 13:20:46 sk RelBeta $
...
(defun dired-readin-insert (dirname)
  ...
  (if (equal default-directory dirname);; i.e., (file-directory-p dirname)
      (dired-ls (if (eq system-type 'vax-vms)
		    dirname

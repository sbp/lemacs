...
#ifdef emacs
void emacs_Xt_focus_event_handler (XEvent *x_event, struct screen *);
#endif
...
{
  register ExternalShellWidget w = (ExternalShellWidget) wid;
...
static void GetGeometry(W, child)
    Widget W, child;
{
    register ExternalShellWidget w = (ExternalShellWidget)W;
 ...
 */
static void ExternalShellRealize (Widget wid, Mask *vmask, XSetWindowAttributes *attr)
{
...
{
    register ExternalShellWidget w = (ExternalShellWidget)gw;
